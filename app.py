...
def get_reflection(client,full_prompt,llm_response,model):
    ...
    2. The query SPECIFICALLY references the correct tables: employees.csv, purchases.csv and lenders.csv, and those tables are properly aliased? (this is the most likely cause of failure)
