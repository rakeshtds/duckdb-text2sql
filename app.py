...
def get_reflection(client,full_prompt,llm_response,model):
    ...
    2. The query SPECIFICALLY references the correct tables: lenders.csv, purchases.csv and lenders.csv, and those tables are properly aliased? (this is the most likely cause of failure)
...
def main():
    ...
    with col:  
        st.image('groqcloud_darkmode1.png')
